...
namespace Norvec
{
    public partial class Form1 : Form
    {
        ...
        NpgsqlConnection baglanti = new NpgsqlConnection("Host=localHost; port=5432; Database=norvectur; username=postgres; password=443651907");
        ...
        private void btnSİl_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Müşteri silinmiştir!", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            // Parametreleri doğrulamak ve eklemek
            if (!int.TryParse(txtBoxTurid.Text, out int turid))
            {
            ...
            if (!int.TryParse(txtBoxMusteriid.Text, out int musterid))
            {
                MessageBox.Show("Geçersiz müşteri id.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                baglanti.Close();
                return;
            }

            if (!int.TryParse(txtUcakBileti.Text, out int ucakBileti))
            {
                MessageBox.Show("Geçersiz uçak bileti numarası.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                baglanti.Close();
                return;
            }
            ...
            {
                MessageBox.Show("Geçersiz oda numarası.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                baglanti.Close();
                return;
            }
            ...
            komut3.Parameters.AddWithValue("@p3", turid);
            komut3.Parameters.AddWithValue("@p4", tcno);
            komut3.Parameters.AddWithValue("@p5", MskTxtTel.Text); // Telefon numarasının doğru formatta olduğundan emin olun.
            komut3.Parameters.AddWithValue("@p6", musterid);
            komut3.Parameters.AddWithValue("@p7", ucakBileti);
            komut3.Parameters.AddWithValue("@p8", cmbBoxCinsiyet.Text);
            komut3.Parameters.AddWithValue("@p9", odaNo);
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string mst_id = dataGridView1.Rows[secilialan].Cells[0].Value.ToString();
        ...
        {
            txtUcakBileti.Text = "4";
        }

        private void button1_Click(object sender, EventArgs e)
        {
            txtUcakBileti.Text = "8";
        }

        private void button2_Click(object sender, EventArgs e)
        {
            txtUcakBileti.Text = "9";
        }
